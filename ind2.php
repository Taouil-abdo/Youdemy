...
<body>
    ...
    <main>
        ...
        <!-- ------------------------ Derniers Courses ajoutés --------------- -->

        <!-- <div id="lastCousers" class="max-w-screen-xl mx-auto p-5 sm:p-10 md:p-16">

            <div class="relative z-10 flex flex-col justify-center items-center h-full text-center">
                <p class="text-4xl font-bold leading-tight mb-12">Latest Articles Added</p>
            </div>
            <div class="grid grid-cols-1 md:grid-cols-3  sm:grid-cols-2 gap-10 round">
                <div
                    class="h-[auto] w-[20rem] bg-gray-300 border-r border-b border-l border-gray-400 lg:border-t lg:border-gray-400 bg-white rounded-b lg:rounded-b-none lg:rounded-r flex flex-col justify-between leading-normal">
                    <a href="app/view/pages/blog.php" class="flex-col items-center bg-gray-300">
                        <img src="app/public/asset/uploads/bg.jpg" alt="Player Image" class="w-full mb-3">

                        <div class="p-4 pt-2">
                            <div class="mb-8">
                                <h2 class="text-gray-900 text-xl font-bold">consectetur adipisicing elit</h2>
                                ...
                                <p class="text-gray-700 text-sm">description / Lorem ipsum dolor sit amet,
                            ...
                            <div class="flex items-center">
                                ...
                                <div class="text-sm">
                                    ...
                                    <p class="text-gray-600">create at</p>
                                </div>
                                <div>
